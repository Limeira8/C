Seu amigo de infância se tornará empreendedor e pediu sua ajuda para que criasse um programa que utilize uma estrutura para armazenar as informações de entrega de cada cliente.
